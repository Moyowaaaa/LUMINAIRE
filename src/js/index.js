...
import groteskBoldFont from "../assets/fonts/SpaceGrotesk-Bold.otf";
import grotedkFont from "../assets/fonts/SpaceGrotesk-Regular.otf";
import groteskMediumFont from "../assets/fonts/SpaceGrotesk-Medium.otf";
import MaropeBold from "../assets/fonts/manrope-bold.otf";
import MaropeFont from "../assets/fonts/manrope-regular.otf";
...
const news = [
  {
    ...
    desc: "Introducing our new ultra-high-performance brand — the world’s first fully electric luxury super-sports car.",
    min: "10 min read",
  },
  {
    image: image2,
    title: "Beyond charging vehicles",
    desc: "Hear about the new ways electric vehicles are powering up  offices and transforming remote businesses",
    min: "7 min read",
  },
  {
    image: image3,
    title: "Never-ending road trip",
    desc: "How the expanding electric network is changing the way  families plan for vacations",
    min: "5 min read",
  },
];
let newsContainer;

newsContainer = Array.from(
  document.querySelectorAll(".newsSection__news-container--container")
);
