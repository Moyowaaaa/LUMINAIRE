...
export const split = () => {
    const p = Array.from(document.querySelectorAll("[data-animation='paragraph']")) as HTMLElement[];
    const H = Array.from(document.querySelectorAll("[data-animation='header']")) as HTMLElement[];
    const f = Array.from(document.querySelectorAll("[data-animation='fade']")) as HTMLElement[];
